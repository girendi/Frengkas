...
public class DetailOrderActivity extends AppCompatActivity {
    ...
    private TextView txtLayanan, txtRentang, txtLokasi, txtWaktu, txtPukul, txtBiaya, txtStatus;
    ...
    private void deleteData() {
        baseService.deleteOrder(id_order).enqueue(new Callback<ResponseBody>() {
            @Override
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Log.e("Error Message Delete", t.getMessage());
            }
        });
    }
